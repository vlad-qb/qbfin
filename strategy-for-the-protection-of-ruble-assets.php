...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-strategy-protection-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title">СТРАТЕГИЯ ЗАЩИТЫ РУБЛЕВЫХ АКТИВОВ</h2>
          <p class="description">
            <span class="bold l">
              КОМПАНИЯ </span><span class="company pl05 pr05">QBF</span> <span class="bold">ПРЕДЛАГАЕТ 2 СТРАТЕГИИ ЗАЩИТЫ РУБЛЕВЫХ АКТИВОВ В РАМКАХ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ ФИНАНСОВЫМИ АКТИВАМИ: ДЕПОЗИТНЫЙ СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ И ХЕДЖИРОВАНИЕ РУБЛЕВЫХ РИСКОВ.</span>
            </p>
...
<!-- PORTFOLIO MENU  -->
    <div class="img-strategy-protection-2 w100r mt05r fixed" style="background-attachment: fixed;">
      <div class="portfolio-menu w90r auto bg bg-gray-label text-center color-white uppercase">
        ...
        <div class="pl02r pr02r pt02r pb02r">
          <div class="column-2">
            <div class="ml05r mr05r">
              <a class="button color-white white-hover block" href="/deposit-weighted-average-portfolio.php">
                <img src="img/icons/icon-reit-sentence.svg" class="icon icon-services w90 h90">
                <div class="mt10 h border-gray-top border-gray-bottom lightgray-block-hover">
                  <div class="size-11 line-h18 mt25 mb20 ml25r mr25r">ДЕПОЗИТНЫЙ СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ</div>
                </div>
              </a>
            </div>
          </div>
          <div class="column-2">
            <div class="ml05r mr05r">
              <a class="button color-white white-hover block" href="/hedging-the-risk-of-ruble.php">
                <img src="img/icons/icon-cogwheel.svg" class="icon icon-services w90 h90">
                <div class="mt10 h border-gray-top border-gray-bottom lightgray-block-hover">
                  <div class="size-11 line-h18 mt25 mb20 ml25r mr25r">ХЕДЖИРОВАНИЕ РУБЛЕВЫХ РИСКОВ</div>
                </div>
              </a>
            </div>
          </div>
        ...
        <div class="column-offset">
          <div class="ml15r mr15r border-left-lightgray border-right-lightgray">
            <div class="ml05r mr05r pt03r pb03r">
              <h3 class="color-teal size-12 mb20">ДЕПОЗИТНЫЙ СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ</h3>
              <p class="mb15">
              В данной стратегии клиент не берет на себя валютные риски, связанные с тем, что вложение рублёвых денежных средств осуществляется по высокому курсу по отношению к доллару, а по окончании срока инвестирования конвертация долларовых активов в рубли происходит по более низкому курсу. </p>
              <p class="mb20">Плюсом стратегии является следующее: в случае если стоимость рубля продолжит снижаться, клиент получит дополнительный доход в виде курсовой разницы. <a class="color-teal gray-hover" href="/deposit-weighted-average-portfolio.php">...подробнее ></a></p>
              <h3 class="color-teal size-12 mb20">ХЕДЖИРОВАНИЕ РУБЛЕВЫХ РИСКОВ</h3>
              <p class="mb15">
              В рамках данного портфеля реализуется стратегия, позволяющая защитить рублевые активы инвестора от снижения стоимости рубля по отношению к американскому доллару, что делает эту стратегию весьма актуальной ввиду текущих геополитических и экономических условий в России. </p>
              
              <p class="mb15">
              Стратегией предусмотрено открытие позиции по фьючерсам на валютную пару USD/RUB в размере 7-10% от суммы рублевых активов. Таким образом, если происходит снижение стоимости российской валюты, то позиция по фьючерсам приносит прибыль, которая компенсирует обесценивание рубля.  </p>
              <p class="mb20">В случае если рубль растет или остается без изменения, происходит закрытие позиции без убытка или позиция вовсе не открывается. <a class="color-teal gray-hover" href="/hedging-the-risk-of-ruble.php">...подробнее ></a> </p>
            </p>
          </div>
        </div>
      </div>
