<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - стратегия защиты рублевых активов</title>
    ...
    <body>
      <?php include 'html/header.html';?>
       <div id="cover" class="img-strategy-protection-1 cover w100r h480 mt-80" style="background-position: center top;">
      ...
      <div class="column-container">
          ...
          <div class="column-2">
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                <h2 class="size-18 color-teal uppercase text-center line-h110">СТРАТЕГИЯ ЗАЩИТЫ РУБЛЕВЫХ АКТИВОВ</h2>
                <p class="size-11 line-h20 text-justify">
                  <span class="bold">
					ИНВЕСТИЦИОННАЯ КОМПАНИЯ </span><span class="color-teal weight-300">QBF ||| investment</span> <span class="bold">ПРЕДЛАГАЕТ 2 СТРАТЕГИИ ЗАЩИТЫ РУБЛЕВЫХ АКТИВОВ В РАМКАХ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ ФИНАНСОВЫМИ АКТИВАМИ: ДЕПОЗИТНЫЙ СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ И ХЕДЖИРОВАНИЕ РУБЛЕВЫХ РИСКОВ.</span>
                </p>
        ...
        <div class="column-offset">
            <div class="ml15r mr15r border-left-lightgray border-right-lightgray">
                <div class="ml05r mr05r pt03r pb03r">
					<h3 class="ml025r color-teal size-12 mb20">ДЕПОЗИТНЫЙ СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ</h3>
                    <p class="ml025r mb15">
                     В данной стратегии клиент не берет на себя валютные риски, связанные с тем, что вложение рублёвых денежных средств осуществляется по высокому курсу по отношению к доллару, а по окончании срока инвестирования конвертация долларовых активов в рубли происходит по более низкому курсу.</p>

					<p class="ml025r mb20">Плюсом стратегии является следующее: в случае если стоимость рубля продолжит снижаться, клиент получит дополнительный доход в виде курсовой разницы.</p>
					<h3 class="ml025r color-teal size-12 mb20">ХЕДЖИРОВАНИЕ РУБЛЕВЫХ РИСКОВ</h3>
					<p class="ml025r mb15">
                    В рамках данного портфеля реализуется стратегия, позволяющая защитить рублевые активы инвестора от снижения стоимости рубля по отношению к американскому доллару, что делает эту стратегию весьма актуальной ввиду текущих геополитических и экономических условий в России.</p>
					 
					<p class="ml025r mb15">
                    Стратегией предусмотрено открытие позиции по фьючерсам на валютную пару USD/RUB в размере 7-10% от суммы рублевых активов. Таким образом, если происходит снижение стоимости российской валюты, то позиция по фьючерсам приносит прибыль, которая компенсирует обесценивание рубля. </p>

					<p class="ml025r mb20">В случае если рубль растет или остается без изменения, происходит закрытие позиции без убытка или позиция вовсе не открывается.</p>
					</p>
                </div>
            </div>
        </div>
...
<div id="parallax-menu" class="img-high-yield-strategy-2 w100r mt80 cover bg-center fixed" style="background-attachment: fixed;">
	...
	<h3 class="size-12 color-white pt30">ВСЕ СТРАТЕГИИ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ</h3>
        ...
        <div class="column-4">
            <div class="ml05r mr05r mt30">
                <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50">
                <div class="mt10 border-darkgray-top border-darkgray-bottom yellow-block-hover">
        ...
        <div class="column-4">
            <div class="ml05r mr05r mt30">
                <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50">
                <div class="mt10 border-darkgray-top border-darkgray-bottom bg-gray-label">
