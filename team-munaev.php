...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - руководство - Зелимхан Мунаев</title>
  ...
  <body>
    ...
    <div id="cover" class="img-team-munaev-1 cover w100r h480 mt-80" style="background-position: right top;">
      ...
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        <div class="w85r auto">
          ...
          <p class="size-11 line-h20 bold text-center">
            ЗЕЛИМХАН МУНАЕВ - ДИРЕКТОР ДЕПАРТАМЕНТА ПРОДАЖ
          </p>
