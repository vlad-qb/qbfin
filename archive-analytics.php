    ...
    <div id="headblock" class="column-container">
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          ...
          <p class="description">
            АНАЛИТИЧЕСКИЙ ДЕПАРТАМЕНТ КОМПАНИИ QBF ПРЕДЛАГАЕТ ВАШЕМУ ВНИМАНИЮ ОБЗОРЫ РЫНКОВ, АКЦИЙ И КОМПАНИЙ, А ТАКЖЕ ЭКСПЕРТНОЕ МНЕНИЕ НАШИХ СПЕЦИАЛИСТОВ ПО КЛЮЧЕВЫМ НАПРАВЛЕНИЯМ ЭКОНОМИКИ.
          </p>
