<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - документы</title>
    ...
    <body>
      ...
      <div id="cover" class="img-documents-1 cover w100r h480 mt-80" style="background-position: center top;">
      ...
      <div class="column-container">
          ...
          <div class="column-2">
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                <h2 class="size-18 color-teal uppercase text-center line-h110">ДОКУМЕНТЫ</h2>
      ...
      <div id="gallery" class="column-container mt60">
        <div class="column-3">
          <div class="gallery-offset ml10r border-white">
        ...
        <div class="column-3">
          <div class="gallery-offset auto border-white">
      ...
      <div class="text-center mt80">
        ...
        <a href="/archive-analytics.php" class="size-12 line-h40 uppercase">Компания</a>
      </div>
      <div class="clearfix"></div>
