...
<html lang="ru">
  ...
  <body>
    ...
    <div id="cover" class="img-branch-office-1 cover w100r h480 mt-80" style="background-position: center top;">
    ...
    <div class="column-2">
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        <div class="w85r auto">
          <h2 class="size-18 color-teal uppercase text-center line-h110">ФИЛИАЛЫ</h2>
