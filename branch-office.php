...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - филиалы</title>
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
    <div id="cover"
      class="img-branch-office-1 cover w100r h400 mt-80"
      ...
      <div class="CUSTOM-1 column-container">
        ...
        <div class="column">
          <div class="column-offset">
            ...
            <div class="column-40r pt07r">
              <div class="size-14 line-h20">
                <p class="weight-300"><span class="bold">О</span>ткрытие клиентского офиса в Киеве стало решающим шагом для компании QBF при выходе на международный уровень. Инвестиционный рынок Украины на момент открытия офиса был сопоставим с российским рынком 2000-х, в связи с чем совет директоров спрогнозировал весьма динамичный рост в сегменте профессионального управления частным капиталом в последующие несколько лет.</p>
