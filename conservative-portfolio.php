...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - консервативная стратегия | консервативный портфель</title>
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-conservative-portfolio-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title">КОНСЕРВАТИВНый портфель</h2>
          <p class="description">
            <span class="bold">
            ДАННЫЙ ПОРТФЕЛЬ - ПОДХОДЯЩЕЕ РЕШЕНИЕ ДЛЯ ТЕХ, КТО ВЫБИРАЕТ НАДЕЖНОСТЬ И РАЗУМНЫЙ УРОВЕНЬ ПРИБЫЛИ. В РАМКАХ ПОРТФЕЛЯ ПРЕОБЛАДАЮТ ИНСТРУМЕНТЫ С ФИКСИРОВАННОЙ ДОХОДНОСТЬЮ, ЧТО ОБЕСПЕЧИВАЕТ СТАБИЛЬНОСТЬ ИНВЕСТИЦИЙ И ЗАЩИТУ ОТ ИНФЛЯЦИОННЫХ РИСКОВ.</span>
          </p>
  ...
  <div class="column-container size-14 color-grey1 line-h26">
    <div class="column-2 pt05r block-offset">
      <div class="column-offset">
        <p class="size-14 weight-300"><span class="bold">П</span>ортфель содержит корпоративные облигации эмитентов развитых стран - США и Европы. Доходность по таким инструментам с 10-летним сроком обращения варьируется в пределах 6 - 7% годовых. Американские и европейские акции с дивидендной доходностью приносят дополнительные 4 - 5% прибыли.  </p>     
      </div>
    </div>
    <div class="column-2 pt05r">
      <div class="column-offset ">
      <p class="size-14 weight-300"><span class="bold">Б</span>лагодаря системе отбора активов и широким возможностям диверсификации (как валютной, так и региональной), негативные изменения рынка незначительно влияют на инвестированный капитал. В итоге инвестор всегда понимает, каким образом стратегия принесла тот или иной результат. </p>
      </div>
    </div>
    <div class="clearfix"></div>
  </div>
      ...
      <div class="w90r auto bg bg-yellow-label text-center">
        <div class="column-container pt40 size-12 color-white">
          <div class="w33r l">
            ...
            <p class="weight-300 mt20 pl05r pr05r">от $300.000</p>
          ...
          <div class="w33r l">
            ...
            <p class="weight-300 mt20 pl05r pr05r">7 дней</p>
            <div class="border-white2 mt30 w100 auto"></div>
          ...
          <div class="w33r l">
            ...
            <p class="weight-300 mt20 pl05r pr05r">20-32%</p>
