<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - архив : рынки за месяц, квартал и год</title>
    ...
    <div class="column-2 content-margin">
      <div class="column-offset bg-white pt50">
        <h2 class="title"> АРХИВ : РЫНКИ ЗА МЕСЯЦ И КВАРТАЛ </h2>
        <p class="description">
          ЭКСПЕРТЫ АНАЛИТИЧЕСКОГО ДЕПАРТАМЕНТА КОМПАНИИ QBF ПРЕДЛАГАЮТ ВАШЕМУ ВНИМАНИЮ ОБЗОРЫ МИРОВЫХ РЫНКОВ ЗА МЕСЯЦ, КВАРТАЛ И ГОД.
        </p>
...
<div id="text-feed">
  <div class="column-container size-14 line-h26 pt05r pb05r">
      <div class="column-2">
          <div class="column-offset">
      				<div class="size-18 weight-300 color-teal text-center pt02r pb02r">
                2015
      				</div>
  				    <div class="ml30 mr30 text-center">
  ...
  <!-- /CONTENT -->
  <!-- CONTENT-2 -->
  <div class="column-container block-offset auto">
      <div class="column pt05r pb05r">
          <div class="line-offset">
