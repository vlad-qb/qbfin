<!DOCTYPE html>
  <html lang="ru">
    ...
    <div class="column-2 content-margin">
      <div class="column-offset bg-white pt05r">
        <h2 class="size-18 line-h50 text-center color-teal uppercase"> АРХИВ : РЫНКИ ЗА МЕСЯЦ И КВАРТАЛ </h2>
...
<!-- FOOTER BLOCK -->
    ...
    <div class="w100r">
          <div class="text-center pt05r">
			...
			<a href="/markets.php" class="size-12 line-h40 uppercase">Рынки</a><a href="/markets.php"><span class="size-14"> ></span>
          </div>	  
    </div>		
    <!-- /FOOTER BLOCK -->
      <div class="clearfix"></div>
