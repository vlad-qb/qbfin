    ...
    <div id="headblock" class="column-container">
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          ...
          <p class="description">
          <span class="date">18.07.2014</span> <span class="color-whitesmoke pl05 pr05">•︎</span><span class="bold"> СКОЛЬКО ДЕНЕГ ПРИДЕТСЯ НАПЕЧАТАТЬ ЕВРОПЕЙСКОМУ ЦБ, ЧТОБЫ ВОЗРОДИТЬ ЕВРОПЕЙСКУЮ ЭКОНОМИКУ</span>
        </p>
...
<div class="column-container pt05r">
  ...
  <div class="column-2 pt05r">
    <div class="column-offset line-h24 size-14">
      ...
      <p class="mt15">Центробанк слишком боится повторения кризиса, связанного с чрезмерной либерализацией, и ведет очень консервативную политику. Последние макроданные свидетельствуют о том, что экономика еврозоны находится на грани рецессии, и на этом фоне нерешительность ЕЦБ может только усугубить ситуацию.</p>
