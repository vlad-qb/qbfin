...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - стратегия защиты рублевых активов | депозитный средневзвешенный портфель</title>
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-deposit-weighted-average-portfolio-1 cover w100r h400 mt-80" 
  ...
  <div class="column-container size-14 line-h26">
    ...
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300"><span class="bold">В</span> зависимости от рыночной конъюнктуры веса финансовых инструментов в портфеле могут варьироваться. Так, доля акций может составлять 65 - 85%, облигаций - 15 - 35%, ETF - 5-15%.</p>
      </div>
    </div>
  </div>
  <div class="clearfix"></div>
  ...
  <div class="column-container size-14 line-h26">
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300"><span class="bold">Р</span>еализация данной стратегии осуществляется в рамках средневзвешенной стратегии управления капиталом на фондовых рынках. Помимо вышеуказанных условий, еще одной особенностью данного продукта, является то, что управляющий ежемесячно проводит расчет прибыли клиента с учетом актуального валютного курса USD/RUB по FOREX.</p>
      </div>
    </div>
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300"><span class="bold">П</span>люсом стратегии является следующее: в случае если стоимость рубля продолжит снижаться, клиент получит дополнительный доход в виде курсовой разницы.</p>
      </div>
    </div>
  </div>
    <!-- CONNECT -->
          ...
          <div class="column-2">
            <div class="ml05r mr05r">
              <a class="button color-white white-hover block" href="/deposit-weighted-average-portfolio.php">
                ...
                <div class="mt10 h border-gray-top border-gray-bottom bg-gray">
