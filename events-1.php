...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-events-1-1 cover w100r h400 mt-80" 
          ...
          <div class="column-offset bg-white pt35">
            ...
            <div class="w85r auto size-12 color-grey1 uppercase mt30">
              <ul>
                ...
                <li class="inline">
                  <a class="active" href="/events.php"> СОБЫТИЯ </a>
...
<div id="content">
  <div class="column-container">
    ...
    <div class="column-2 pt05r">
      <div class="column-offset line-h24 size-14">
        <p><span class="bold">Г</span>руппа компаний QBF предлагает стать пайщиком перспективного жилого комплекса комфорткласса «Грибовский Лес», который уже в ближайшее время будет иметь большой спрос у покупателей.</p>
