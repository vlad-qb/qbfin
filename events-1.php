...
<html lang="ru">
  ...
  <body>
    ...
    <div id="cover" class="img-events-1-1 cover w100r h480 mt-80" style="background-position: center top;">
    ...
    <div class="column-2">
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        ...
        <p class="size-12 line-h20 ml40 mr40 text-center">
          <span class="color-teal">15.06.2015</span> <span class="color-whitesmoke">•</span> <a href="/expert-1.html"><span class="bold gray-hover">ЭФФЕКТИВНЫЕ ИНВЕСТИЦИИ В НЕДВИЖИМОСТЬ НОВОГО ФОРМАТА</span></a>
        </p>
