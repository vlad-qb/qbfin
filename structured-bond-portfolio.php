...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - консервативная стратегия | структурированный облигационный портфель</title>
  ...
  <body>
    ...
    <div id="cover" class="img-structured-bond-portfolio-1 cover w100r h480 mt-80" style="background-position: center top;">
  ...
  <div class="column-container size-14 color-grey1 line-h26">
    <div class="column-2">
      <p class="mt70 ml07r mr10r size-14 weight-300"><span class="bold">Д</span>ля реализации стратегии используются корпоративные облигации и акции с дивидендной доходностью. </p>
      
      <p class="mt20 ml07r mr10r size-14 weight-300">Дополнительный доход инвестор получает от роста стоимости акций / опционов или премии от продажи опционных контрактов. </p>
      <p class="mt20 ml07r mr10r size-14 weight-300">Последний сценарий возможен в случае низкой волатильности базового актива (акции).</p>
    </div>
    <div class="column-2">
      <p class="mt70 ml07r mr10r size-14 weight-300"><span class="bold">Р</span>иск-менеджмент портфеля предусматривает инвестирование в облигации с максимально возможным кредитным рейтингом и в акции компаний с капитализацией свыше $10 млрд, с дивидендной доходностью от 5% годовых. </p>
      
      <p class="mt20 ml07r mr10r size-14 weight-300">Работа с опционами строится на основе анализа особенностей базового актива, и подход управляющих может меняться в зависимости от рыночной конъюнктуры.</p>
    </div>
    <div class="clearfix"></div>
  </div>
  <!--Text-->
    ...
    <div class="label w90r auto bg bg-yellow-label line-h40 text-center">
      <div class="column-3">
        <div class="ml05r mr05r mt30">
          ...
          <p class="size-12 color-white weight-300">от $1.000.000</p>
      ...
      <div class="column-3">
        <div class="ml05r mr05r mt30">
          ...
          <p class="size-12 color-white weight-300">9-12%</p>
          <div class="border-white2 auto w100 mt10 mb5"></div>
          <p class="size-12 color-white weight-300">ВОЗНАГРАЖДЕНИЕ УПРАВЛЯЮЩЕГО</p>
          <p class="size-12 color-white weight-300">комиссия за управление: 1% + за успех: 10% (с дохода более 12% годовых)</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="column-container size-14 line-h26">
    ...
    <div class="column-2">
      <p class="mt70 ml07r mr10r size-14 weight-300"><span class="bold">К</span>роме того, активы в рамках стратегии должны входить в индекс S&P500 или в основные региональные индексы (для неамериканских эмитентов). Показатели TDB/EBITDA и TDB/Assets не выше средних значений по отрасли.</p>
    </div>
  </div>
  <div class="clearfix"></div>
  <!--Text-->
  ...
  <div class="column-container mt60">
    ...
    <div class="clearfix"></div>
    <div class="column-3">
      <div class="img-structured-bond-portfolio-2 h450 contain mt30 mb50" style="background-size: contain; background-repeat: no-repeat; background-position: center center;"></div>
    </div>
    <div class="column-2 size-14 line-h32 w50r mr03r mb40 r">
      <div>
        ...
        <div class="border-lightgray text-center weight-300 mb5">
          ...
          <span>результат </span><span class="color-yellow">•︎</span> $94 500 (9,45%) (с учетом стоимости РЕПО)</div>
          <div class="border-lightgray bg-lightgray text-center mb5 line-h40">актив: акции с дивидендной доходностью</div>
          <div class="border-lightgray text-center weight-300 mb5">
            <span>объем </span><span class="color-yellow">•︎</span> $95 000<br/>
            <span>результат </span><span class="color-yellow">•︎</span> $5 225 (0,52%)</div>
            <div class="border-lightgray text-center weight-300 mb5">
              <span>итог </span><span class="color-yellow">•︎</span> $99 725 (9,97%)</div>
              <div class="border-lightgray bg-lightgray text-center mb5 line-h40 bold">расчет доходности портфеля | переменная часть</div>
              <div class="border-lightgray text-center weight-300 mb5">
                <span>сценарий 1: акции <span class="color-yellow">▲</span> опционы <span class="color-yellow">▼</span><br/></span>
              результат: 9,97% (+ цена акций) (- цена опционов)</div>
              <div class="border-lightgray text-center weight-300 mb5">
                <span>сценарий 2: акции <span class="color-yellow">▼</span> опционы <span class="color-yellow">▲</span><br/></span>
              результат: 9,97% (+ цена опционов) (- цена акций)</div>
              <div class="border-lightgray text-center weight-300 mb5">
                <span>сценарий 3: акции <span class="color-yellow">►</span> опционы <span class="color-yellow">▲</span><br/></span>
              результат: 9,97% + опционы (продажа контрактов)</div>
            </div>
          </div>
          <div class="clearfix"></div>
        </div>
        ...
        <div class="w100r">
          <div class="text-center mt80">
            ...
            <a href="/service.php"><span class="size-14">< </span></a><a href="/service.php" class="size-12 line-h40 uppercase">УСЛУГИ</a> <span class="color-teal size-10">•︎</span> <a href="/asset-management.php" class="size-12 line-h40 uppercase">Доверительное управление</a><a href="/asset-management.php"><span class="size-14"> ></span>
          </div>
        </div>
        <div class="clearfix"></div>
