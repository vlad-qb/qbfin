...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
    <div id="cover"
      class="img-bond-option-portfolio-1 cover w100r h400 mt-80"
    ...
    <div id="headblock" class="column-container">
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> ОБЛИГАЦИОННО-ОПЦИОННЫЙ портфель </h2>
          <p class="size-11 line-h20 text-justify mt30 pl05r pr05r">
            <span class="bold"> СТРАТЕГИЯ ПРЕДПОЛАГАЕТ, ЧТО 95% КАПИТАЛА ИНВЕСТОРА НАПРАВИТСЯ В КОРПОРАТИВНЫЕ ОБЛИГАЦИИ, А 5% - В ОПЦИОНЫ, НА АКЦИИ КРУПНЕЙШИХ АМЕРИКАНСКИХ КОМПАНИЙ. ТАКАЯ ДИВЕРСИФИКАЦИЯ ПОЗВОЛЯЕТ ИНВЕСТОРУ ЗАРАБАТЫВАТЬ БОЛЬШЕ 25% ГОДОВЫХ ПРИ МИНИМАЛЬНЫХ РИСКАХ НА ВЛОЖЕННЫЙ КАПИТАЛ. </span>
          </p>
      ...
      <div class="size-14 line-h20 color-grey1">
        <div class="column-2 pt05r">
          <div class="column-offset pl05r pr05r">
            ...
            <p class="mt05r weight-300">
              При этом потенциальный доход от размещений в опционы не ограничен и в среднем составляет 20 - 30%. Такой метод размещения капитала никогда не потеряет своей актуальности.
            </p>
          </div>
        </div>
        <div class="column-2 pt05r">
          <div class="column-offset pl05r pr05r">
            <p class="mt05r weight-300">
              <span class="bold">В</span>ажнейший элемент в этой портфельной стратегии - риск-менеджмент, в частности качественный отбор облигаций.
            </p>
            <p class="mt05r weight-300">
              А использование самых ликвидных опционов на акции крупнейших американских корпораций позволяет оперативно открывать и закрывать позиции и сокращать таким образом воздействие внешних факторов на актив.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="w90r auto bg bg-yellow-label text-center">
        <div class="column-container size-11 line-h22 color-white">
          <div class="w33r l pt04r pb02r">
            ...
            <p class="weight-300 mb02r pt05r pb05r pl05r pr05r">от $500.000</p>
            <div class="border-white2 w100 auto"></div>
            <p class="weight-300 mt05r pt05r pb05r pl05r pr05r">УРОВЕНЬ ЗАЩИТЫ КАПИТАЛА</p>
            <p class="weight-300 pt05r pl05r pr05r">100%</p>
          </div>
          <div class="w33r l pt04r pb02r">
            <div class="border-white2 w100 auto"></div>
          ...
          <div class="w33r l pt04r pb02r">
            ...
            <p class="weight-300 mb02r pt05r pb05r pl05r pr05r">8,5-25%</p>
            <div class="border-white2 w100 auto"></div>
            <p class="weight-300 mt05r pt05r pl05r pr05r">ВОЗНАГРАЖДЕНИЕ УПРАВЛЯЮЩЕГО</p>
            <p class="weight-300 pt05r pl05r pr05r">комиссия за успех: 20% + за управление: от 0,5 до 1,5%</p>
          </div>
          <div class="clearfix"></div>
        </div>
      </div>
    ...
    <div class="column-container size-14 line-h22">
      ...
      <div class="column-2">
        <div class="column-offset">
          <p class="pl05r pr05r weight-300"><span class="bold">Ч</span>тобы облигация была отобрана в портфель, она должна обладать высоким кредитным рейтингом от Standard & Poor's, Moody's и Fitch для корпоративных облигаций. Целевой доходностью по облигациям служит отметка 6% годовых. </p>
        ...
        <div class="column-3-2 size-14 line-h28" style="float:right;">
          <div class="">
            ...
            <div class="border-lightgray text-center weight-300 mb5 pt02r pb01r">
              ...
              <span class="color-yellow">•︎</span> 95% или $475 000
            </div>
            <div class="border-lightgray text-center weight-300 mb5 pt02r pb01r">
              <span>опционы на акции<br/></span>
              <span class="color-yellow">•︎</span> 5% или $25 000
            </div>
            <div class="border-lightgray bg-lightgray text-center mb5 bold pt02r pb01r">результат инвестиций</div>
            <div class="border-lightgray text-center weight-300 mb5 pt02r pb01r">
              <span>облигации<br/></span>
              <span class="color-yellow">•︎</span> $475 000 х 6% = $503 500 (1% к сумме инвестиций)
            </div>
            <div class="border-lightgray text-center weight-300 mb5 pt02r pb01r">
              <span>опционы<br/></span>
              <span class="color-yellow">•︎</span> $25 000 х 0 - 400% = $0 - 125 000 (0 - 25% к сумме инвестиций)
            </div>
            <div class="border-lightgray text-center weight-300 mb5 pt02r pb01r">
              <span>итог<br/></span>
              <span class="color-yellow">•︎</span> $503 500 - $628 500 (3,5 - 25,6% к сумме инвестиций)
            </div>
          </div>
        </div>
  ...
  <div class="clearfix"></div>
  <div class="img-high-yield-strategy-2 w100r mt04r fixed" style="background-attachment: fixed;">
    <div class="bg-yellow-label w90r auto bg bg-label text-center color-white uppercase">
      <h2 class="size-12 line-h22 uppercase pt15 pb10">ВАРИАНТЫ КОНСЕРВАТИВНОЙ СТРАТЕГИИ</h2>
      <div class="pl02r pr02r pb15">
        <div class="column-4">
            <div class="ml03r mr03r">
              <div class="pt03r pb03r">
                <img src="img/icons/icon-reit-sentence.svg" class="icon icon-services w90 h90">
              </div>
              <div class="border-yellow-top border-yellow-bottom lightyellow-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r">
                <a class="color-white white-hover" href="/conservative-portfolio.php">КОНСЕРВАТИВНЫЙ ПОРТФЕЛЬ</a>
              </div>
            </div>
          </div>
        </div>
        <div class="column-4">
          <div class="ml03r mr03r">
            ...
            <div class="border-yellow-top border-yellow-bottom bg-lightyellow">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r">
                <a class="color-white white-hover" href="/bond-option-portfolio.php">ОБЛИГАЦИОННО- ОПЦИОННЫЙ <br/>ПОРТФЕЛЬ</a>
              </div>
            </div>
          </div>
        </div>
        <div class="column-4">
          <div class="ml03r mr03r">
            ...
            <div class="border-yellow-top border-yellow-bottom lightyellow-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r">
                <a class="color-white white-hover" href="/bond-repo-portfolio.php">ОБЛИГАЦИОННЫЙ <br/>РЕПО ПОРТФЕЛЬ</a>
              </div>
            </div>
          </div>
        </div>
        <div class="column-4">
          <div class="ml03r mr03r">
            ...
            <div class="border-yellow-top border-yellow-bottom lightyellow-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r">
                <a class="color-white white-hover" href="/structured-bond-portfolio.php">СТРУКТУРИРОВАННЫЙ ОБЛИГАЦИОННЫЙ ПОРТФЕЛЬ</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="label w90r auto bg bg-label text-center color-white uppercase">
      <h2 class="size-12 line-h22 uppercase pt15 pb10 ml05r mr05r">ВСЕ СТРАТЕГИИ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ</h2>
      <div class="pl02r pr02r pb15">
        <div class="column-4">
          <div class="ml03r mr03r">
            <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50 mt10 mb10">
            <div class="border-darkgray-top border-darkgray-bottom blue-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r">
                <a class="color-white white-hover" href="/high-yield-strategy.php">Высокодоходная стратегия</a>
              </div>
            </div>
          </div>
        </div>
        <div class="column-4">
          <div class="ml03r mr03r">
            <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50 mt10 mb10">
            <div class="border-darkgray-top border-darkgray-bottom green-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r"><a class="color-white white-hover" href="/weighted-average-strategy.php">Средневзвешенная стратегия</a></div>
            </div>
          </div>
        </div>
        <div class="column-4">
          <div class="ml03r mr03r">
            <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50 mt10 mb10">
            <div class="border-darkgray-top border-darkgray-bottom orange-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r"><a class="color-white white-hover" href="/conservative-strategy.php">Консервативная стратегия</a></div>
            </div>
          </div>
        </div>
        <div class="column-4">
          <div class="ml03r mr03r">
            <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50 mt10 mb10">
            <div class="border-darkgray-top border-darkgray-bottom grey-block-hover">
              <div class="size-11 line-h18 pt20 pb20 ml25r mr25r"><a class="color-white white-hover" href="/strategy-for-spane-protection-of-ruble-assets.php">Стратегия защиты активов</a></div>
            </div>
          </div>
        </div>
        <div class="clearfix"></div>
    ...
    <div class="text-center pt01r">
      <a href="/services.php"><span class="size-14"> < </span></a>
      <a href="/services.php" class="size-12 line-h40 uppercase">УСЛУГИ</a> <span class="color-teal size-10">•︎</span>
      <a href="/asset-management.php" class="size-12 line-h40 uppercase">ДОВЕРИТЕЛЬНОЕ УПРАВЛЕНИЕ</a>
      <a href="/asset-management.php"><span class="size-14"> > </span></a>
    </div>
    <!-- /FOOTER BLOCK -->
    <div class="clearfix"></div>
