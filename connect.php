...
<html lang="ru">
  ...
  <body>
    ...
    <div id="cover" class="img-connect-1 cover w100r h480 mt-80" style="background-position: center top;">
      ...
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        <div class="w85r auto">
          ...
          <p class="size-11 line-h20 text-justify">
            ...
            <br/><br/>
            <span class="bold">ВОСПОЛЬЗУЙТЕСЬ ФОРМОЙ ОБРАТНОЙ СВЯЗИ, ЧТОБЫ ЗАДАТЬ ИНТЕРЕСУЮЩИЙ ВАС ВОПРОС ПО ИНВЕСТИЦИОННОМУ БИЗНЕСУ ИЛИ СВЯЖИТЕСЬ С НАШИМИ СПЕЦИАЛИСТАМИ В КОНКРЕННОМ ОФИСЕ ПО ТЕЛЕФОНУ ИЛИ ЭЛЕКТРОННОЙ ПОЧТЕ.</span>
          </p>
