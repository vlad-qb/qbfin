...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-team-gorsheneva-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
		  ...
		  <span class="bold"> МАРГАРИТА ГОРШЕНЕВА - ДИРЕКТОР ПО РАЗВИТИЮ </span>
          </p>
