...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - консервативная стратегия</title>
  ...
  <body>
    ...
    <div id="cover" class="img-conservative-strategy-1 cover w100r h480 mt-80" style="background-position: center top;">
    ...
    <div class="column-2">
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        <div class="w85r auto">
          <h2 class="size-18 color-teal uppercase text-center line-h110">КОНСЕРВАТИВНАЯ СТРАТЕГИЯ</h2>
          <p class="size-11 line-h20 text-justify">
            <span class="bold">
              ИНВЕСТИЦИОННАЯ КОМПАНИЯ </span><span class="color-teal weight-300">QBF ||| investment</span> <span class="bold">ПРЕДЛАГАЕТ 4 КОНСЕРВАТИВНЫЕ СТРАТЕГИИ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ ФИНАНСОВЫМИ АКТИВАМИ: КОНСЕРВАТИВНЫЙ ПОРТФЕЛЬ, ОБЛИГАЦИОННО-ОПЦИОННЫЙ ПОРТФЕЛЬ, ОБЛИГАЦИОННЫЙ РЕПО ПОРТФЕЛЬ И СТРУКТУРИРОВАННЫЙ ОБЛИГАЦИОННЫЙ ПОРТФЕЛЬ.</span>
            </p>
    ...
    <div class="clearfix"></div>
    <div id="parallax-menu" class="img-conservative-strategy-2 w100r mt80 cover fixed" style="background-attachment: fixed; background-position: center top;">
      <div class="label w90r auto bg bg-yellow-label text-center uppercase">
        <div class="column-4">
        ...
        <div class="column-offset">
          <div class="ml15r mr15r border-left-lightgray border-right-lightgray">
            <div class="ml05r mr05r pt03r pb03r">
              <h3 class="ml025r color-teal size-12 mb20">КОНСЕРВАТИВНЫЙ ПОРТФЕЛЬ</h3>
              <p class="ml025r mb20">
                Данный портфель - подходящее решение для тех, кто выбирает надежность и разумный уровень прибыли. В рамках портфеля преобладают инструменты с фиксированной доходностью, что обеспечивает стабильность инвестиций и защиту от инфляционных рисков. Портфель содержит корпоративные облигации эмитентов развитых стран - США и Европы.
              </p>
              <h3 class="ml025r color-teal size-12 mb20">ОБЛИГАЦИОННО - ОПЦИОННЫЙ ПОРТФЕЛЬ </h3>
              <p class="ml025r mb20 weight-300">
                Стратегия предполагает, что 95% капитала инвестора направится в корпоративные облигации, а 5% - в опционы, на акции крупнейших американских компаний. Такая диверсификация позволяет инвестору зарабатывать больше 25% годовых при минимальных рисках на вложенный капитал.
              </p>
              <h3 class="ml025r color-teal size-12 mb20">ОБЛИГАЦИОННЫЙ РЕПО ПОРТФЕЛЬ</h3>
              <p class="ml025r mb20 weight-300">
                Стратегия опирается на монетарную политику крупнейших ЦБ мира. Низкие процентные ставки позволяют использовать заемный капитал для инвестиций. Валовая доходность портфеля генерируется за счет купонного дохода по корпоративным облигациям компаний развитых экономик.
              </p>
              <h3 class="ml025r color-teal size-12 mb20">СТРУКТУРИРОВАННЫЙ ОБЛИГАЦИОННЫЙ ПОРТФЕЛЬ</h3>
              <p class="ml025r mb20 weight-300">
                Данный портфель один из самых эффективных и надежных на фондовом рынке, так как в рамках него инвестор получает 100% защиту капитала и фиксированный доход по итогу года. Особенность портфеля - возможность получить доход выше заявленного.
              </p>
            </div>
          </div>
        </div>
    ...
    <div id="parallax-menu" class="img-high-yield-strategy-2 w100r mt80 cover bg-center fixed" style="background-attachment: fixed;">
      <div class="label w90r auto bg bg-label text-center uppercase">
        ...
        <div class="column-4">
          <div class="ml05r mr05r mt30">
            <img src="img/icons/icon-marker.svg" class="icon icon-services w50 h50">
            <div class="mt10 border-darkgray-top border-darkgray-bottom bg-yellow-label">
