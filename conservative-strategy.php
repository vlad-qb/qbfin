      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          ...
          <p class="description">
           ...
           КОМПАНИЯ QBF ПРЕДЛАГАЕТ 4 КОНСЕРВАТИВНЫЕ СТРАТЕГИИ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ ФИНАНСОВЫМИ АКТИВАМИ: КОНСЕРВАТИВНЫЙ ПОРТФЕЛЬ, ОБЛИГАЦИОННО-ОПЦИОННЫЙ ПОРТФЕЛЬ, ОБЛИГАЦИОННЫЙ РЕПО ПОРТФЕЛЬ И СТРУКТУРИРОВАННЫЙ ОБЛИГАЦИОННЫЙ ПОРТФЕЛЬ.
        ...
        <div class="column-offset">
          <div class="ml15r mr15r border-left-lightgray border-right-lightgray">
            <div class="ml05r mr05r pt03r pb03r">
              <h3 class="color-teal size-12 mb20">КОНСЕРВАТИВНЫЙ ПОРТФЕЛЬ</h3>
              <p class="mb20">
                Данный портфель - подходящее решение для тех, кто выбирает надежность и разумный уровень прибыли. В рамках портфеля преобладают инструменты с фиксированной доходностью, что обеспечивает стабильность инвестиций и защиту от инфляционных рисков. Портфель содержит корпоративные облигации эмитентов развитых стран - США и Европы. <a class="color-teal gray-hover" href="/conservative-portfolio.php">...подробнее ></a>
              </p>
              <h3 class="color-teal size-12 mb20">ОБЛИГАЦИОННО - ОПЦИОННЫЙ ПОРТФЕЛЬ </h3>
              <p class="mb20 weight-300">
                Стратегия предполагает, что 95% капитала инвестора направится в корпоративные облигации, а 5% - в опционы, на акции крупнейших американских компаний. Такая диверсификация позволяет инвестору зарабатывать больше 25% годовых при минимальных рисках на вложенный капитал. <a class="color-teal gray-hover" href="/bond-repo-portfolio.php">...подробнее ></a>
              </p>
              <h3 class="color-teal size-12 mb20">ОБЛИГАЦИОННЫЙ РЕПО ПОРТФЕЛЬ</h3>
              <p class="mb20 weight-300">
                Стратегия опирается на монетарную политику крупнейших ЦБ мира. Низкие процентные ставки позволяют использовать заемный капитал для инвестиций. Валовая доходность портфеля генерируется за счет купонного дохода по корпоративным облигациям компаний развитых экономик. <a class="color-teal gray-hover" href="/bond-option-portfolio.php">...подробнее ></a>
              </p>
              <h3 class="color-teal size-12 mb20">СТРУКТУРИРОВАННЫЙ ОБЛИГАЦИОННЫЙ ПОРТФЕЛЬ</h3>
              <p class="mb20 weight-300">
                Данный портфель один из самых эффективных и надежных на фондовом рынке, так как в рамках него инвестор получает 100% защиту капитала и фиксированный доход по итогу года. Особенность портфеля - возможность получить доход выше заявленного. <a class="color-teal gray-hover" href="/structured-bond-portfolio.php">...подробнее ></a>
              </p>
            </div>
          </div>
        </div>
