<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - аналитика</title>
    ...
    <body>
      ...
      <div id="cover" class="img-analytics-1 cover w100r h480 mt-80" style="background-position: center top;">
         ...
         <div class="column-2">
          ...
          <div class="column-2">
            <div class="column-offset" style="background:white;height:30px;margin-top:0;">
              <h2 class="size-18 color-teal uppercase text-center line-h110">АНАЛИТИКА</h2>
