<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - консервативная стратегия | облигационный портфель</title>
    ...
    <body>
      <?php include 'html/header.html';?>
       <div id="cover" class="img-bond-repo-portfolio-1 cover w100r h480 mt-80" style="background-position: center top;">
      ...
      <div class="column-container">
          ...
          <div class="column-2">
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                <h2 class="size-18 color-teal uppercase text-center line-h110">ОБЛИГАЦИОННЫЙ портфель</h2>
                <p class="size-11 line-h20 text-justify">
                  <span class="bold">
					СТРАТЕГИЯ ОПИРАЕТСЯ НА МОНЕТАРНУЮ ПОЛИТИКУ КРУПНЕЙШИХ ЦБ МИРА. НИЗКИЕ ПРОЦЕНТНЫЕ СТАВКИ ПОЗВОЛЯЮТ ИСПОЛЬЗОВАТЬ ЗАЕМНЫЙ КАПИТАЛ ДЛЯ ИНВЕСТИЦИЙ. ВАЛОВАЯ ДОХОДНОСТЬ ПОРТФЕЛЯ ГЕНЕРИРУЕТСЯ ЗА СЧЕТ КУПОННОГО ДОХОДА ПО КОРПОРАТИВНЫМ ОБЛИГАЦИЯМ КОМПАНИЙ РАЗВИТЫХ ЭКОНОМИК.</span>
                </p>
