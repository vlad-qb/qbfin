    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title"> ОБЛИГАЦИОННЫЙ портфель </h2>
          <p class="description">
      ...
      <div class="w90r auto bg bg-yellow-label text-center">
        <div class="column-container pt40 size-12 color-white">
          ...
          <div class="w33r l">
            ...
            <p class="weight-300 mt20 pl05r pr05r">12-17%</p>
            <div class="border-white2 mt25 w100 auto"></div>
            <p class="weight-300 mt20 pl05r pr05r">ВОЗНАГРАЖДЕНИЕ УПРАВЛЯЮЩЕГО</p>
            <p class="weight-300 mt20 mb25 pl05r pr05r">комиссия за управление: 2%</p>
          </div>
          <div class="clearfix"></div>
        </div>
      </div>
