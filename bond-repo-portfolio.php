...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-bond-repo-portfolio-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> ОБЛИГАЦИОННЫЙ портфель </h2>
          <p class="size-11 line-h20 text-justify mt30 pl05r pr05r">
		  <span class="bold"> СТРАТЕГИЯ ОПИРАЕТСЯ НА МОНЕТАРНУЮ ПОЛИТИКУ КРУПНЕЙШИХ ЦБ МИРА. НИЗКИЕ ПРОЦЕНТНЫЕ СТАВКИ ПОЗВОЛЯЮТ ИСПОЛЬЗОВАТЬ ЗАЕМНЫЙ КАПИТАЛ ДЛЯ ИНВЕСТИЦИЙ. ВАЛОВАЯ ДОХОДНОСТЬ ПОРТФЕЛЯ ГЕНЕРИРУЕТСЯ ЗА СЧЕТ КУПОННОГО ДОХОДА ПО КОРПОРАТИВНЫМ ОБЛИГАЦИЯМ КОМПАНИЙ РАЗВИТЫХ ЭКОНОМИК. </span>
          </p>
