...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-weighted-average-strategy-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title">СРЕДНЕВЗВЕШЕННАЯ СТРАТЕГИЯ</h2>
          <p class="description">
            <span class="bold">
              КОМПАНИЯ QBF ПРЕДЛАГАЕТ 3 СРЕДНЕВЗВЕШЕННЫЕ СТРАТЕГИИ ДОВЕРИТЕЛЬНОГО УПРАВЛЕНИЯ ФИНАНСОВЫМИ АКТИВАМИ: ИНДЕКСНЫЙ ETF ПОРТФЕЛЬ, СРЕДНЕВЗВЕШЕННЫЙ ВАЛЮТНЫЙ ПОРТФЕЛЬ И СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ.
            </span>
          </p>
...
<!-- PORTFOLIO MENU  -->
    <div class="img-weighted-average-strategy-2 w100r mt05r fixed" style="background-attachment: fixed;">
      <div class="portfolio-menu bg-green-label w90r auto bg bg-label text-center color-white uppercase">
        <div class="border-green-bottom pt02r pb02r">
          <h2 class="size-12 line-h22 uppercase bold">ВАРИАНТЫ СРЕДНЕВЗВЕШЕННОЙ СТРАТЕГИИ</h2>
        </div>
        ...
        <div class="column-offset">
          <div class="ml15r mr15r border-left-lightgray border-right-lightgray">
            <div class="ml05r mr05r pt03r pb03r">
              <h3 class="color-teal size-12 mb20">ИНДЕКСНЫЙ ETF ПОРТФЕЛЬ</h3>
              <p class="mb20">
                В рамках стратегии инвестор имеет неограниченные возможности по вложению капитала в части выбора активов. Перед инвестором открываются возможности размещения в крупнейшие индексные, региональные, сырьевые и секторные фонды мира. <a href="/index-portfolio.php" class="color-teal gray-hover">...подробнее ></a>
              </p>
              <h3 class="color-teal size-12 mb20">СРЕДНЕВЗВЕШЕННЫЙ ВАЛЮТНЫЙ ПОРТФЕЛЬ </h3>
              <p class="mb20 weight-300">
                Значительная часть стратегии подразумевает хеджирование валютных рисков с помощью работы со всеми доступными валютными парами. В портфеле также задействованы ценные бумаги корпоративных эмитентов: акции и облигации. Большая доля валют в портфеле защищает капитал инвестора от неблагоприятных курсовых колебаний. <a href="/weighted-currency-portfolio.php"  class="color-teal gray-hover">...подробнее ></a>
              </p>
              <h3 class="color-teal size-12 mb20">СРЕДНЕВЗВЕШЕННЫЙ ПОРТФЕЛЬ </h3>
              <p class="mb20 weight-300">
                В рамках портфеля реализуются стратегии с оптимальным соотношением доходности и риска. В результате рост стоимости портфеля должен опередить динамику индекса S&P500. Акции американских эмитентов - основной инструмент средневзвешенного портфеля. <a href="/weighted-average-portfolio.php"  class="color-teal gray-hover">...подробнее ></a>
              </p>
            </div>
          </div>
        </div>
