...
<html lang="ru">
    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> РУКОВОДСТВО </h2>
          <p class="size-11 line-h20 text-center mt30 pl05r pr05r">
		  <span class="bold"> РОМАН ШПАКОВ - ПРЕДСЕДАТЕЛЬ СОВЕТА ДИРЕКТОРОВ КОМПАНИИ </span>
          </p>
  ...
  <div class="column-container size-14 line-h20">
    <div class="column-2">
      <div class="column-offset pt05r">
        <p class="size-14 weight-300"><span class="bold">Б</span>ольше всего вопросов приходится решать с клиентами, которые требуют максимальной индивидуализации услуг вроде создания отдельной мини-инфраструктуры, например фонда или выпуска отдельного класса акций фонда.</p>
        <p class="mt20 size-14 weight-300">Также приходится решать нетривиальные задачи, когда клиенту интересно работать на нетрадиционных для нас рынках, таких как рынка и Южной Америки или Австралии. И тут уже надо понимать, стоит ли игра свеч. У нас отработанные связи с контрагентами по всему миру - банками, брокерами, кастоди, админист­раторами, - по­этому особых сложностей в создании небольшой инфраструктуры нет.</p>
    ...
    <div class="column-2">
      <div class="column-offset pt05r">
        <p class="size-14 weight-300">Отдельной клиентской «проблемой» можно назвать случаи, когда клиенты не ставят перед нами конкретных задач и сроков работы. И главное тут - совместная четкая проработка задач и целей нашего сотрудничества еще до его начала. </p>
        ...
        <p class="mt20 size-14 weight-300">Конечно, на финансовых рынках сделать это значительно легче, чем в реальном секторе, но и в реальном секторе тоже есть инструменты, позволяющие изменять стратегию: чаще всего это хорошая юридическая подготовка до старта проекта. </p>
        <p class="mt20 size-14 weight-300">Мы стараемся избегать работы с инвесторами, чей горизонт инвестирования на финансовых рынках не превышает полутора лет. А если речь идет о реальном секторе, то тут минимальный горизонт инвестирования расширяется до 7 - 10 лет.</p>
      </div>
    </div>
  </div>
  <div class="clearfix"></div>
  ...
  <div class="column-container size-14 line-h20">
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300">Еще один сложный вопрос - зарубежные юрисдикции и их специфические требования, особенно в условиях меняющейся экономической и политической обстановки.</p>
    ...
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300">В итоге ответ нашли рядом - и географически, и политически: Мальта, государство в Средиземном море и член Евросоюза. Создание необходимой клиенту инфраструктуры заняло даже меньше времени, а цена практически не отличалась, да и банки ЕС совсем по-другому смотрят на фонд, зарегистрированный в рамках Евросоюза.</p>
        ...
        <p class="mt20 size-14 weight-300">Доверие клиента важно каждой компании, но если в части финансов его можно подкреплять качественной работой и радующим клиента результатом, то в предоставлении услуг, которые касаются его образа жизни, индивидуальных предпочтений и вкусов, без искренности и подробного описания своего запроса просто не обойтись.</p>
      </div>
    </div>
  </div>
  <div class="clearfix"></div>
  ...
  <div class="column-container size-14 line-h20">
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300">Однажды одному из менеджеров поступил тревожный звонок от действующего клиента, который был весьма озадачен своей ситуацией. Клиенту нужна была помощь в подборе имиджмейкера на время отсутствия постоянного. Задавать вопросы вроде «почему вы решили обратиться именно к нам?» мы и не думали, желание клиента попросить нас о помощи в любом важном для него деле - порой просто награда.</p>
      </div>
    </div>
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300">Разумеется, имиджмейкера мы подобрали, еще больше запомнилось, как менеджер практически на себе проверял возможности стилиста. Но главное - чтобы клиент был счастлив. <span class="color-black">|</span><span class="color-gray">|</span><span class="color-teal">|</span></p>
