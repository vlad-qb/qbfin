    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase pl05r pr05r"> КОНСУЛЬТАЦИОННОЕ УПРАВЛЕНИЕ </h2>
    ...
    <div class="column-container">
      <div class="column">
        <div class="column-offset">
          ...
          <p class="pt04r line-h22 text-center size-14 weight-300 color-white">
          ...
          <p class="mt20 mb05r line-h22 text-center size-14 weight-300 color-white">
