<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - руководство - Никита Селиванов</title>
    ...
    <body>
      ...
      <div id="cover" class="img-team-selivanov-1 cover w100r h480 mt-80" style="background-position: right top;">
            ...
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                ...
                <p class="size-11 line-h20 bold text-center">
                  НИКИТА СЕЛИВАНОВ - РУКОВОДИТЕЛЬ ОТДЕЛА МЕЖДУНАРОДНОГО ТРЕЙДИНГА
                </p>
