...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-real-estate-1 cover w100r h400 mt-80" 
          ...
          <div class="column-offset bg-white pt35">
            ...
            <div class="w85r auto size-12 color-grey1 uppercase mt30">
              <ul>
                ...
                <li class="inline">
                  <a class="active" href="/real-estate.php"> ИНВЕСТИЦИИ В НЕДВИЖИМОСТЬ </a>
                </li>
              </ul>
            </div> 
        </div>
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title">ИНВЕСТИЦИИ В НЕДВИЖИМОСТЬ</h2>
          <p class="description">
            <span class="bold">
              ИНВЕСТИЦИИ В НЕДВИЖИМОСТЬ ИСТОРИЧЕСКИ ЯВЛЯЮТСЯ НАИБОЛЕЕ ВОСТРЕБОВАННЫМИ НА РОССИЙСКОМ РЫНКЕ. ТАКИЕ ВЛОЖЕНИЯ ДЕНЕЖНЫХ СРЕДСТВ СЧИТАЮТСЯ НАИБОЛЕЕ ПРОСТЫМИ И ПОНЯТНЫМИ. ЭКОНОМИЧЕСКИЕ КРИЗИСЫ, ВОЛАТИЛЬНОСТЬ НЕФТЯНЫХ КОТИРОВОК И, КАК СЛЕДСТВИЕ, КУРСА РУБЛЯ ЗАСТАВЛЯЮТ ИНВЕСТОРОВ ИСКАТЬ «ТИХУЮ ГАВАНЬ» ДЛЯ СВОИХ АКТИВОВ.
            </span>
          </p>
...
<!-- /ALERT -->
  <div class="column-container line-h20 size-14">
    ...
    <div class="column-2 pt05r">
      <div class="column-offset">
        <p class="size-14 weight-300"><span class="bold">Н</span>а протяжении последних 14,5 лет инвестиции в REIT оказывались крайне успешными. Кумулятивный доход от вложений в REIT за данный период составил более 400%. </p>
