...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - средневзвешенная стратегия | средневзвешенный валютный портфель</title>
  ...
  <body>
    ...
    <div id="cover" class="img-weighted-currency-portfolio-1 cover w100r h480 mt-80" style="background-position: center top;">
    ...
    <div class="column-2">
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        <div class="w85r auto">
          <h2 class="size-18 color-teal uppercase text-center line-h110">СРЕДНЕВЗВЕШЕННЫЙ ВАЛЮТНЫЙ ПОРТФЕЛЬ</h2>
          <p class="size-11 line-h20 text-justify">
            <span class="bold">
            ДАННАЯ СТРАТЕГИЯ ПОДРАЗУМЕВАЕТ ХЕДЖИРОВАНИЕ ВАЛЮТНЫХ РИСКОВ С ПОМОЩЬЮ РАБОТЫ С КЛЮЧЕВЫМИ ВАЛЮТНЫМИ ПАРАМИ, НО НЕ ОГРАНИЧИВАЯСЬ ИМИ, ЧТО ПОЗВОЛЯЕТ ЗАЩИТИТЬ КАПИТАЛ ИНВЕСТОРА ОТ НЕБЛАГОПРИЯТНЫХ КОЛЕБАНИЙ КУРСОВ.</span>
          </p>
