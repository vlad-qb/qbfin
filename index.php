<!DOCTYPE html>
  <html lang="ru">
    ...
    <body>
      ...
      <div id="cover" class="img-index-1 cover w100r h480 mt-80" style="background-position: center top;">
        <div class="column-container" style="height:30px;position:relative;top:450px;">
          <div class="column-3">
          ...
          <div class="column-3 no-mobile no-tablet-v">
            <div class="column-offset" style="background:white;height:30px;margin-top:0;">
