        ...
        <div class="w33r l pt05r pb02r block-offset">
          <div class="w33-offset line-h20 size-14">
            <div class="pt10 pb10 border-left-lightgray border-right-lightgray">
              ...
              <p class="text-center mt25 size-14 ml07r mr07r mb15 weight-300"><span class="bold">Е</span>сли речь идет об инвестициях в различные регионы мира, то это отсутствие необходимости открытия дополнительных брокерских счетов, а также необходимости выбора актива и его анализа, что порой затруднено языковыми преградами. </p>
            </div>
          </div>
        </div>
        <div class="w33r l pt05r pb02r block-offset">
...
<!-- PORTFOLIO MENU -->
    <div class="img-high-yield-strategy-2 w100r fixed" style="background-attachment: fixed;">
      <div class="portfolio-menu pt02r bg-green-label w90r auto bg bg-label text-center color-white uppercase">
        <div class="border-green-bottom pb02r">
