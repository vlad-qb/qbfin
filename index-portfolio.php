    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title">ИНДЕКСНЫЙ ETF ПОРТФЕЛЬ</h2>
          <p class="description">
            В РАМКАХ ЭТОЙ СТРАТЕГИИ ПЕРЕД ИНВЕСТОРОМ ОТКРЫВАЮТСЯ ВОЗВОЖНОСТИ ПО РАЗМЕЩЕНИЮ КАПИТАЛА В КРУПНЕЙШИЕ ИНДЕКСНЫЕ РЕГИОНАЛЬНЫЕ, СЫРЬЕВЫЕ И СЕКТОРНЫЕ ФОНДЫ МИРА. ТАКИЕ ВОЗМОЖНОСТИ РЕАЛИЗУЮТСЯ ПОСРЕДСТВОМ ETF.
          </p>
