    ...
    <div id="headblock" class="column-container">
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          ...
          <p class="description">
            <span class="bold"> АНАЛИТИЧЕСКИЙ ДЕПАРТАМЕНТ КОМПАНИИ QBF ПРЕДЛАГАЮТ ВАШЕМУ ВНИМАНИЮ ОБЗОРЫ АКЦИЙ КРУПНЕЙШИХ И НАИБОЛЕЕ ПЕРСПЕКТИВНЫХ ДЛЯ ИНВЕСТИРОВАНИЯ КОМПАНИЙ. </span>
          </p>
