    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          ...
          <p class="description">
            <span class="bold"> ДЛЯ НАС ВАЖЕН КАЧЕСТВЕННО НОВЫЙ УРОВЕНЬ ОБСЛУЖИВАНИЯ КЛИЕНТОВ, ПОЭТОМУ ВСЕ СОТРУДНИКИ КОМПАНИИ - ДИПЛОМИРОВАННЫЕ СПЕЦИАЛИСТЫ, ВЛАДЕЮЩИЕ НЕСКОЛЬКИМИ ЯЗЫКАМИ, ДЕЛОВОЙ ЭТИКОЙ, ЗНАНИЯМИ СПЕЦИФИКИ ИНВЕСТИЦИОННОГО БИЗНЕСА.
			</span>
          </p>
