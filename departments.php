    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> ДЕПАРТАМЕНТЫ </h2>
          <p class="size-11 line-h20 text-justify mt30 pl05r pr05r">
            <span class="bold"> ДЛЯ НАС ВАЖЕН КАЧЕСТВЕННО НОВЫЙ УРОВЕНЬ ОБСЛУЖИВАНИЯ КЛИЕНТОВ, ПОЭТОМУ ВСЕ СОТРУДНИКИ КОМПАНИИ - ДИПЛОМИРОВАННЫЕ СПЕЦИАЛИСТЫ, ВЛАДЕЮЩИЕ НЕСКОЛЬКИМИ ЯЗЫКАМИ, ДЕЛОВОЙ ЭТИКОЙ, ЗНАНИЯМИ О ДЕЯТЕЛЬНОСТИ И СПЕЦИФИКЕ НАШЕГО БИЗНЕСА.
			</span>
          </p>
