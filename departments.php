      ...
      <div class="mt5 line-h20 size-14">
        ...
        <div class="w33r l pt05r block-offset">
          <div class="w33-offset border-left-lightgray border-right-lightgray pl05r pr05r">
            ...
            <p class="mt15 mb15 size-14 ml07r mr07r"><span class="bold">М</span>ы стремимся быть понятыми для людей с любым образованием. Для нас важно выбрать те пути коммуникации, которые формируют представление о корпорации, как о своем частном партнере и личном друге. На которого можно положиться, и которому можно доверять в условиях меняющейся экономической ситуации.</p>
            <div class="column-offset">
              <h3 class="text-center size-14"><div class="w100r h40 line-h40 auto bg-lightgray lightgray-block-hover2"><a class="color-teal" href="/vacancies.php">актуальные вакансии ></a></div></h3>
            </div>
          </div>
      ...
      <div class="mt5 line-h20 size-14">
        <div class="w33r l pt05r block-offset">
          <div class="w33-offset border-left-lightgray border-right-lightgray pl05r pr05r">
            ...
            <p class="mt15 mb15 size-14 ml07r mr07r"><span class="bold">С</span>пециалисты компании имеют большой опыт работы на международных финансовых рынках, и, благодаря им, компании смогла пройти через все штормы и кризисы в мировой экономике, продолжая показывать высокие результаты для наших клиентов. </p>
        ...
        <div class="w33r l pt05r block-offset">
          <div class="w33-offset border-left-lightgray border-right-lightgray pl05r pr05r">
            ...
            <p class="mt15 mb15 size-14 ml07r mr07r"><span class="bold">П</span>рофессиональные навыки и компетентность специалистов данного отдела позволили нам добиться высоких профессиональных результатов и помогают двигаться вперед, опираясь на международные практики и стандарты организации труда.</p>
        ...
        <div class="w33r l pt05r block-offset">
          <div class="w33-offset border-left-lightgray border-right-lightgray pl05r pr05r">
            ...
            <p class="mt15 mb15 size-14 ml07r mr07r"><span class="bold">Г</span>лавные задачи, которые стоят перед сотрудниками Административного департамента:</p>
