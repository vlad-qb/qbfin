  ...
  <html lang="ru">
    ...
    <body>
      <?php include 'html/header.html';?>
       <div id="cover" class="img-asset-management-1 cover w100r h480 mt-80" style="background-position: center top;">
      ...
      <div class="column-container">
          ...
          <div class="column-2">
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                <h2 class="size-18 color-teal uppercase text-center line-h110">ДОВЕРИТЕЛЬНОЕ УПРАВЛЕНИЕ</h2>
                <p class="size-11 line-h20 text-justify">
                  <span class="bold">ДОВЕРИТЕЛЬНОЕ УПРАВЛЕНИЕ АКТИВАМИ - ЛИЦЕНЗИРОВАННЫЙ ПРОЦЕСС УПРАВЛЕНИЯ ДЕНЕЖНЫМИ СРЕДСТВАМИ ИЛИ ЦЕННЫМИ БУМАГАМИ КЛИЕНТОВ, ПЕРЕДАННЫМИ ПРОФЕССИОНАЛЬНОМУ УПРАВЛЯЮЩЕМУ ДЛЯ ИНВЕСТИРОВАНИЯ НА ФИНАНСОВОМ РЫНКЕ, С ЦЕЛЬЮ ПОЛУЧЕНИЯ ДОХОДОВ ДЛЯ КЛИЕНТА.</span>
                </p>
