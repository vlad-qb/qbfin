...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-offices-1 cover w100r h400 mt-80" 
        ...
        <div class="column-2 content-margin text-center size-8 line-h24 uppercase">
          <div class="column-offset bg-white pt35">
           ...
           <div class="w85r auto size-12 color-grey1 uppercase mt30">
             ...
             <a class="active" href="/offices.php">ОФИСЫ</a>
    ...
    <div class="column-2 pt05r">
      <div class="column-offset">
        <div class="">
          ...
          <h4 class="text-center size-14 pt05r line-h30 weight-300">123317, Москва</h4>
    ...
    <div class="column-2 pt05r block-offset">
      <div class="column-offset"> 
        <div class="">
          ...
          <div class="title-line-teal"></div>
          <h4 class="text-center size-14 pt05r line-h30 weight-300">195112, Санкт-Петербург</h4>
    ...
    <div class="column-2 pt05r block-offset">
      <div class="column-offset">   
        <div class="">
          ...
          <div class="title-line-teal"></div>
          <h4 class="text-center size-14 pt05r line-h30 weight-300">01601, Киев</h4>
  ...
  <!-- FOOTER BLOCK -->
    ...
    <div class="w100r">
          <div class="text-center ">
            <img id="lighthouse" src="img/icons/icon-lighthouse.svg" class="icon icon-main"><br>
