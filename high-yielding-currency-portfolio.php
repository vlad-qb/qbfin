...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-high-yielding-currency-portfolio-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title">ВЫСОКОДОХОДНЫЙ ВАЛЮТНЫЙ ПОРТФЕЛЬ</h2>
          <p class="description">
            ОСНОВНАЯ ЗАДАЧА ПОРТФЕЛЯ - ПРИНЕСТИ ИНВЕСТОРУ МАКСИМУМ ДОХОДА ПРИ 50-ПРОЦЕНТНОЙ ЗАЩИТЕ КАПИТАЛА. ПОРТФЕЛЬ ОБЛАДАЕТ ЗНАЧИТЕЛЬНОЙ ВОЛАТИЛЬНОСТЬЮ И КОРРЕЛИРУЕТ С ДИНАМИКОЙ ВАЛЮТНОГО РЫНКА.
          </p>
