<!DOCTYPE html>
  <html lang="ru">
    ...
    <body>
      ...
      <div id="cover" class="img-culture-1 cover w100r h480 mt-80" style="background-position: center top;">
      ...
      <div class="column-container">
          ...
          <div class="column-2">
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                <h2 class="size-18 color-teal uppercase text-center line-h110">КУЛЬТУРА</h2>
                <p class="size-11 line-h20 text-justify">
                  <span class="bold">СОТРУДНИКИ</span><span class="color-teal size-12 weight-300"> QBF ||| investment</span> <span class="bold">ЯВЛЯЮТСЯ НАШИМ ГЛАВНЫМ КОНКУРЕНТНЫМ ПРЕИМУЩЕСТВОМ ПЕРЕД ДРУГИМИ ФИНАНСОВЫМИ КОМПАНИЯМИ.</span>
				  <br/><br/>
				  <span class="bold">МЫ НАЦЕЛЕНЫ НА СОЗДАНИЕ СПЛОЧЕННОГО, ОТВЕТСТВЕННОГО И КВАЛИФИЦИРОВАННОГО ПЕРСОНАЛА, СПОСОБНОГО АДЕКВАТНО РЕАГИРОВАТЬ НА ПОСТОЯННО МЕНЯЮЩИЕСЯ ТРЕБОВАНИЯ РЫНКА И ОЖИДАНИЯ КЛИЕНТОВ.</span>
                </p>
