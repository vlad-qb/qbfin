...
<html lang="ru">
  ...
  <div class="column-container pt05r">
    ...
    <div class="column-2">
      <div class="column-offset line-h20 size-14">
        <p class="size-14 weight-300"><span class="bold">К</span>то такие сотрудники QBF ||| Investment? Это, в первую очередь, незаурядные и целеустремленные люди.</p>
  ...
  <div class="column-container pt05r block-offset line-h20 size-14">
    ...
    <div class="column-2">
      <div class="column-offset">
        <p class="size-14 weight-300"><span class="bold">М</span>ы регулярно сталкиваемся со сложными задачами. Иногда некоторые из них кажутся невыполнимыми. Но трудности нас не пугают, а стимулируют становиться лучше. Постоянно возникающие возможности проявить себя - это и есть привилегия находиться в компании QBF ||| investment.</p>
