...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-laws-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> ЗАКОНОДАТЕЛЬСТВО </h2>
...
<!-- FOOTER BLOCK -->
    ...
    <div class="w100r">
          <div class="text-center pt05r">
			...
			<a href="/archive-news.php" class="size-12 line-h40 uppercase">АРХИВ</a><a href="/archive-news.php"><span class="size-14"> ></span>
          </div>	  
    </div>		
    <!-- /FOOTER BLOCK -->
<div class="clearfix"></div>
