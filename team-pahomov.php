<!DOCTYPE html>
  <html lang="ru">
    <head>
      ...
      <title>QBF ||| investment - руководство - Владимир Пахомов</title>
    ...
    <body>
      ...
      <div id="cover" class="img-team-pahomov-1 cover w100r h480 mt-80" style="background-position: right top;">
            ...
            <div class="column-offset h30 bg-white" style="margin-top:0;">
              <div class="w85r auto">
                ...
                <p class="size-11 line-h20 bold text-center">
                  ВЛАДИМИР ПАХОМОВ - ДИРЕКТОР ФИЛИАЛЬНОЙ СЕТИ КОМПАНИИ
                </p>
...
<div class="column-container size-14 line-h20">
    ...
    <div class="column-2">
		...
		<span class="bold">Владимир Пахомов</span>, Директор филиальной сети</p>
    </div>
</div>
<div class="clearfix"></div>
<!--Text-->	  
    ...
    <div class="column-30r mt90" style="padding-top:2%;">
      <div class="column-offset">
        <div class="text-center weight-300 size-14 line-h40">
            <a href="/expert-1.php" class="size-12 bold gray-hover">ТОЧКИ РОСТА</a>
			<div class="w100r auto border-grey-bottom"></div>
            <h4 class="size-12"><span class="color-teal weight-300">08.11.2014</span> <span class="color-black">|</span><span class="color-gray">|</span><span class="color-teal">|</span> архив</h4>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
...
<div id="offices" class="CUSTOM-1 column-container">
   <div class="column">
    ...
    <div class="column-30r mt90" style="padding-top:2%;">
      <div class="column-offset">
        <div class="text-center weight-300 size-14 line-h40">
            <a href="/expert-1.php" class="size-12 bold gray-hover">В КОМАНДЕ СО ЗВЕЗДОЙ</a>
			<div class="w100r auto border-grey-bottom"></div>
            <h4 class="size-12"><span class="color-teal weight-300">14.12.2013</span> <span class="color-black">|</span><span class="color-gray">|</span><span class="color-teal">|</span> архив</h4>
        </div>
        <div class="clearfix"></div>
      </div>
    </div>
