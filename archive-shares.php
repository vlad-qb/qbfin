    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          <h2 class="title"> АРХИВ : АКЦИИ </h2>
          <p class="description">
		        ЭКСПЕРТЫ АНАЛИТИЧЕСКОГО ДЕПАРТАМЕНТА КОМПАНИИ QBF ПРЕДЛАГАЮТ ВАШЕМУ ВНИМАНИЮ ОБЗОРЫ АКЦИЙ КРУПНЕЙШИХ И НАИБОЛЕЕ ПЕРСПЕКТИВНЫХ ДЛЯ ИНВЕСТИРОВАНИЯ КОМПАНИЙ.
          </p>
    ...
    <div class="w100r">
      <div class="text-center ">
        ...
        <a href="/analytics/" class="size-12 uppercase"> АНАЛИТИКА </a>
			  ...
			  <a href="/shares.php" class="size-12 uppercase"> АКЦИИ </a>
      </div>	  
    </div>		
    <!-- /FOOTER BLOCK -->
    <div class="clearfix"></div>
