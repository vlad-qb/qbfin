...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - архив : пресса о нас</title>
    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> АРХИВ : ПРЕССА О НАС </h2>
...
<!-- FOOTER BLOCK -->
    ...
    <div class="w100r">
          <div class="text-center pt05r">
			...
			<a href="/press-about-us.php" class="size-12 line-h40 uppercase">ПРЕССА О НАС</a><a href="/press-about-us.php"><span class="size-14"> ></span>
          </div>	  
    </div>		
    <!-- /FOOTER BLOCK -->
<div class="clearfix"></div>
