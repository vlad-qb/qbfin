...
<html lang="ru">
  <head>
    ...
    <title>QBF ||| investment - архив : новости</title>
  ...
  <body>
    ...
    <div id="cover" class="img-archive-news-1 cover w100r h480 mt-80" style="background-position: center top;">
    ...
    <div class="column-2">
      <div class="column-offset h30 bg-white" style="margin-top:0;">
        <div class="w85r auto">
          <h2 class="size-18 color-teal uppercase text-center line-h110">АРХИВ : НОВОСТИ</h2>
  ...
  <div class="text-center mt80">
    ...
    <a href="/news.php" class="size-12 line-h40 uppercase">НОВОСТИ</a>
  </div>
  <div class="clearfix"></div>
