...
<html lang="ru">
  ...
  <body>
    ...
    <!-- HEADBLOCK -->
      <div id="cover" 
            class="img-news-1 cover w100r h400 mt-80" 
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt50">
          ...
          <p class="description">
		        ОБЗОР СОБЫТИЙ КОМПАНИИ, ЗАКОНОДАТЕЛЬНЫЕ АКТЫ И ДРУГИЕ ПРАВОВЫЕ ДОКУМЕНТЫ. ПУБЛИКАЦИИ В СМИ О КОМПАНИИ И КОММЕНТАРИИ ЭКСПЕРТОВ КОМПАНИИ В ПРЕССЕ..
          </p>
  ...
  <!-- FOOTER BLOCK -->
    ...
    <div class="w100r">
          <div class="text-center ">
            ...
            <a href="/archive-news.php" class="size-12 uppercase">НОВОСТИ</a>
          </div>	  
    </div>		
    <!-- /FOOTER BLOCK -->
  <div class="clearfix"></div>
