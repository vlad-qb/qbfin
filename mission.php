...
<html lang="ru">
    ...
    <!-- HEADBLOCK -->
      ...
      <div class="column-2 content-margin">
        <div class="column-offset bg-white text-center pt05r">
          <h2 class="size-18 line-h50 color-teal uppercase"> МИССИЯ И ЦЕННОСТИ </h2>
  ...
  <div class="column-container pt05r">
    <div id="gallery" class="column-2 auto">
    ...
    <div class="column-2">
      <div class="gallery-offset w80r auto line-h20 size-14">
