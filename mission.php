      ...
      <div class="line-h20 size-14">
        <div class="column-3 pt05r block-offset">
          <div class="column-offset text-center">
            ...
            <p class="pt05r block-offset size-14 ml05r mr05r text-center"><span class="bold">К</span>омпания дорожит именем и репутацией, которые заслужила за годы упорной работы. В финансовой сфере репутация - это главный актив компании. Уверены, что управление финансами должно быть этичным, а сами деньги должны работать на созидательные цели.</p>
          </div>
        </div>
        <div class="column-3 pt05r block-offset">
          <div class="column-offset text-center">
        ...
        <div class="column-3 pt05r block-offset">
          <div class="column-offset text-center">
            ...
            <p class="pt05r block-offset size-14 ml05r mr05r text-center"><span class="bold">QBF</span> создает долгосрочные отношения с клиентами. Мы делаем все для того, чтобы человек, пришедший к нам, был полностью удовлетворен полученными результатами и мог с гордостью рекомендовать нас друзьям, знакомым, партнерам. Мы бережно относимся к доверию клиента и стремимся оправдать это доверие.
</p>
          </div>
        </div>
      </div>
      ...
      <div class="line-h20 size-14">
        ...
        <div class="column-3 text-center pt05r block-offset">
          <div class="column-offset">
            ...
            <p class="pt05r block-offset size-14 ml05r mr05r text-center"><span class="bold">К</span>омпания стремится стать лучшей во всех аспектах своей деятельности. Мы постоянно развиваем отношения с клиентами. Думаем о личностном и профессиональном развитии сотрудников.Развитие для нас - это приоритет по достижению все более высоких результатов.</p>
          </div>
        </div>
      </div>
    </div>
